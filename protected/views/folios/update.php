...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . Folios::label(2), 'icon' => 'list', 'url' => array('index')),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . Folios::label(); ?> <?php echo CHtml::encode($model) ?></legend>
