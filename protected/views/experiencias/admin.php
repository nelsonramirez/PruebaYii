...
$this->breadcrumbs=array(
	'Experienciases'=>array('index'),
	Yii::t('AweCrud.app', 'Manage'),
);

$this->menu=array(
	array('label' => Yii::t('AweCrud.app', 'List') . ' ' . Experiencias::label(2), 'icon' => 'list', 'url' => array('index')),
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('experiencias-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'Manage') ?> <?php echo Experiencias::label(2) ?>    </legend>
